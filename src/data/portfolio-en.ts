...
export const contentEn: PortfolioData = {
  ...
  capabilitiesSection: {
    ...
    items: [
      ...
      { title: 'Incremental modernization', description: 'Replace rigid interfaces and legacy workflows with modern, responsive web experiences while preserving active databases and backend logic.', evidence: 'Pre-sales and collections flow adapted for mobile devices (sales reps), and a React/Vite dashboard for the sales department connected to the core system.', technologies: ['React', 'Vite', 'PHP', 'Bootstrap', 'JavaScript'], icon: 'modernization' },
